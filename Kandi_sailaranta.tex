...
\title{Eleentunnistus Kinect-sensorilla}
% 2-osainen otsikko:
...
\TITLE{Eleentunnistus Kinect-sensorilla}
...
\DEPT{Tietojenkäsittelytieteen laitos}
% suomi:
...
\INSTRUCTOR{D.Sc.(Tech) Markus Koskela}
...
\KEYWORDS{Kinect, eleentunnistus, syvyyskuva, syvyyskamera, ChaLearn, hahmontunnistus}
...
\PAGES{28}
%\PAGES{22}  % kaikki sivut laskettuna nimiölehdestä lähdeluettelon tai 
