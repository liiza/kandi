...
Tavallisen värikuvan lisäksi Kinect-sensori tarjoaa syvyyskuvaa kohteesta. Syvyyskuva kertoo kohteen etäisyyden kamerasta ja luo näin kolmiuloitteista videokuvaa. 
...
ihmishahmo ei välttämättä erotu esimerkiksi väritykseltään taustasta. Kinectin syvyyskameran avulla taustan irroitus onnistuu kuitenkin luotettavammin kuin pelkän 
...
Hahmontunnistuksessa ratkaiseva vaihe on usein oikeiden piirteiden valinta eli piirreirroitus. Videokuvasta voidaan valita piirteeksi esimerkiksi 
...
mutta eivät ranganseurausta tai muuta valmista hahmontunnistietoa. Haasteita toivat vaihtelevat taustat ja valaistukset videokuvalla.  \citep{6239178}\\
...
Esimerkiksi HOG-piirteet kuvaavat kuvan intensitettivaihtelun gradienttien suuntaa. Kuva jaetaan pieniin alueisiin, soluihin, 
...
Pisteiden valinnassa hyödynnetään värityksen intensiteettivaihtelua ja tilastolllisia menetelmiä.  \citep {790410} \\
...
Kaikki kilpailijat käyttivät jonkilaista piirteiden tiivistystä tai kuvausta toiseen lineaariavaruuteen. \citep {6239178}\\ 
...
(Most Likelihood) -menetelmällä. Kyseessä on Bayesialainen menetelmä eli jakauma tunnetaan, mutta ei parametreja.
...
tiettyä tilasarjaa Q kerrotaan todenäköisyydellä $P(Q|\lambda)$ eli todenäköisyydellä tilasarjalle Q esiintyyä luokassa $\lambda$. 
...
kaikkien näytteiden olevan samanpituisia eli koostuvan tietystä ennaltamäärätystä määrästä tiloja. Tämä saattaa asettaa
...
joukossa suurin osa käytti tunnistukssa menetelmää, joka huomioi videon ajallisen rakenteen. Tällöin videokuvasta valitaan piirteet, joiden
...
että huolimatta hyvästä sijoituksestaan meneltemä oli myös yksi kilpailun nopeimmista. \citep{chalearn2}\\
...
sarjan pysäytyskuvia.\citep {6239185} \\
...
On huomiotava, että Viterbin algoritmiä käytetään kahdella tasolla. Menetelmän alimmalla tasolla algoritmiä käytetään Markovin piilomallin
kanssa tunnistamaan yksittäinen liike. Toisaalta Viterbin algoritmiä käytetään myös ylemmällä tasolla tunnistamaan todennäköisin liikesarja.\citep {6239185}\\
...
Kilpailutyöt eivät huomioineet 3D-kuvaa erityisesti piirrevalinnassa tai tunnistusmentelmissä tai ainakaan tätä näkökulmaa ei tuotu erityisesti
...
intensiteettivaihteeluun perustuvia piirteitä kuten HOG-piirteet. Erityisiä perusteluita tälle ei kuitenkaan esitetty.
