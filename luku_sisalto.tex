...
tilasarja, joka todennököisimmin on muodostanut tämän havainnon. Parametrit eli tilat ja todennäköisyydet on opetettu mallien perusteella. \\
...
\begin{figure}[htb]
  \begin{center}
	...
	Tarkotuksena on löytää tilasarja, joka kaikken todennäköisimmin muodostaa havainnon. Kuvan esittämässä tilanteessa todennäköisin tilasarja
